...
3 PARA: str, wrd, newWrd
*/
function myReplace(str, wrd, newWrd) {
    if (wrd[0] === wrd[0].toUpperCase()) {
        newWrd = newWrd[0].toUpperCase() + newWrd.slice(1);
    } else {
        newWrd = newWrd[0].toLowerCase() + newWrd.slice(1);
    }
    return str.replace(wrd, newWrd);
}
